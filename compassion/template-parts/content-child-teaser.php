...
//ModifJK
$thumb[0] = str_replace('z_0.6','z_0.8,q_70',(str_replace('w_320','w_609',str_replace('h_420','h_205',$thumb[0]))));
$child_meta = get_child_meta(get_the_id());
?>

<article class="column medium-6 large-3 blog-teaser child-teaser child" data-equalizer-watch>
 ...
 <a href="<?php the_permalink(); ?>">
    ...
    <div class="content" style="padding:5px;">
      <a href="<?php the_permalink(); ?>">
        ...
        <ul>
          <li><strong><?php _e('Land', 'compassion'); ?> </strong><?php echo $child_meta['country']; ?></li>
          <li><strong><?php _e('Alter', 'compassion'); ?> </strong><?php echo $child_meta['age']; ?> <?php _e('Jahre', 'compassion'); ?></li>
