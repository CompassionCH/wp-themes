...
<table cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
    <tr>
        <td>
            ...
            <h1 style="text-align: center; padding: 25px 0;">Un enfant pour vous !</h1>
            <?php $child_meta = get_child_meta($child_id); ?>

            <div style="padding: 0 30px;">
                <p><?= nl2br(htmlspecialchars($post_data['text_email'])) ?></p>

                <h3>A propos de <?php echo $child_meta['name']; ?></h3>
                ...
                <p><a href="<?= get_home_url().'?p='.$child_id ?>">Plus d'infos sur <?= $child_meta['name'] ?></a></p>

                    <hr>

                    <p>Si vous avez des questions au sujet du parrainage, nous restons volontiers à votre
                        disposition: Téléphone: 0800 784 773 (lundi à vendredi de 9h00 à 12h00 - 13h00 à 16h00) –
                        Adresse e-mail: info@compassion.ch</p>

                    <p>En espérant que vous ferez bientôt partie de la grande famille internationale de Compassion.</p>
                </div>

                <p style="text-align: center;padding-top:30px"><img
                            src="<?= get_template_directory_uri() ?>/assets/img/compassion-logo-dark-fr.png"
